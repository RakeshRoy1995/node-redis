...
router.patch('/update', role_validator_1.updateRoleSchema, error_validation_1.default, role_controller_1.updateRole);
router.post('/create', role_validator_1.createRoleSchema, error_validation_1.default, role_controller_1.createRole);
